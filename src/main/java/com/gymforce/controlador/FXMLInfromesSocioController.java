...
public class FXMLInfromesSocioController {
    ...
    @FXML
    private JFXTreeTableView<?> tblViewInfMembresias;
    ...
    @FXML
    private JFXTreeTableView<?> tblViewInfClases;
    ...
    @FXML
    private JFXTreeTableView<?> tblViewInfPlanesEntren;
    ...
    @FXML
    private JFXTreeTableView<?> tblViewInfDietas;
